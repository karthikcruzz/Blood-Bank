...
<tr><td class="lefttd">Password</td><td><input type="password" name="t6" required="required" pattern="[0-9]{2,10}" title="please enter only numbers between 2 to 10 length" /></td></tr>
<tr><td class="lefttd">Confirm Password</td><td><input type="password" name="t7" required="required" pattern="[0-9 ]{2,10}" title="please enter only numbers between 2 to 10 length" /></td></tr>
