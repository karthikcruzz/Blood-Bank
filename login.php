...
<tr><td class="lefttd">Password</td><td><input type="password"name="t2"  required="required" pattern="[0-9]{2,10}" title="please enter only numbers between 2 to 10 length"  /></td></tr>
